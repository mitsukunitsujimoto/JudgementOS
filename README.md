...
経営者の意思決定文脈を保存するデモ・API のセットアップは **[docs/vercel-neon-setup.md](docs/vercel-neon-setup.md)** を参照してください。
...
デモ: `output/judgment-structure-demo.html`（`vercel dev` 経由で API も利用可能）
